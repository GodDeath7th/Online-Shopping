...
<body>
    ...
    <div class = "container" style = "width: 800px;margin:100px auto">
     <h1>Edit Profile</h1>
     <form action = "profile-edit-finish-process.jsp">
      ...
      <div class="form-group">
       ...
       <input type="password" readonly class="form-control-plaintext" name = "password" value = "<%=request.getParameter("password")%>">
      </div>
      <div class="form-group">
       <label>Phone Number</label>
       <input type="text" readonly class="form-control-plaintext" name = "phone_number" value = "<%=request.getParameter("phone_number")%>">
       <small class="form-text text-muted">We'll never share your phone number with anyone else.</small>
      </div>
      <div class="form-group">
       <label>User Type</label>
       <input type="text" readonly class="form-control-plaintext" value = "<%=request.getParameter("user_type")%>">
      </div>
      <%
           if(request.getParameter("info") != null){
        	   if(request.getParameter("info").equals("fail")){
        	       out.println("<p style='color:red;''>Edit profile fail !</p>");
        	   }
           }
       %>
