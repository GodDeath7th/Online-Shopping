                                    ...
                                    <div class="row form-group">
                                        <div class="col-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="city1" placeholder="Enter your city" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-8">
                                            <div class="form-group">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="province" class=" form-control-label">Select Province</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="area" class=" form-control-label">Select distract</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <select name="select" id="area" class="form-control">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row form-group">
